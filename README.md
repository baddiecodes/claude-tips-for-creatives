# 45 AI Tips for Creatives: Claude.ai + Cursor Edition
...
**Claude.ai Tips**
- [Tip 1: use Projects to give Claude a permanent memory](#tip-1-use-projects-to-give-claude-a-permanent-memory)
- [Tip 2: set a system prompt at the project level](#tip-2-set-a-system-prompt-at-the-project-level)
- [Tip 3: talk to Claude with your voice](#tip-3-talk-to-claude-with-your-voice)
- [Tip 4: break big creative tasks into smaller ones](#tip-4-break-big-creative-tasks-into-smaller-ones)
- [Tip 5: context is like milk — fresh and condensed](#tip-5-context-is-like-milk--fresh-and-condensed)
- [Tip 6: upload your brand guidelines as a reference file](#tip-6-upload-your-brand-guidelines-as-a-reference-file)
- [Tip 7: prompt structure that actually works](#tip-7-prompt-structure-that-actually-works)
- [Tip 8: use Claude as a writing partner, not a ghostwriter](#tip-8-use-claude-as-a-writing-partner-not-a-ghostwriter)
- [Tip 9: the "keep X, change Y" iteration method](#tip-9-the-keep-x-change-y-iteration-method)
- [Tip 10: use Claude to critique your own work](#tip-10-use-claude-to-critique-your-own-work)
- [Tip 11: Claude for UX copy and microcopy](#tip-11-claude-for-ux-copy-and-microcopy)
- [Tip 12: Claude for brief writing](#tip-12-claude-for-brief-writing)
- [Tip 13: use Artifacts for shareable deliverables](#tip-13-use-artifacts-for-shareable-deliverables)
- [Tip 14: Claude as a research tool](#tip-14-claude-as-a-research-tool)
- [Tip 15: use Claude to translate jargon into plain language](#tip-15-use-claude-to-translate-jargon-into-plain-language)
- [Tip 16: build a personal prompt library](#tip-16-build-a-personal-prompt-library)
- [Tip 17: Claude for naming, taglines, and ideation sprints](#tip-17-claude-for-naming-taglines-and-ideation-sprints)
- [Tip 18: Claude for competitive analysis](#tip-18-claude-for-competitive-analysis)
- [Tip 19: Claude for stakeholder presentations](#tip-19-claude-for-stakeholder-presentations)
- [Tip 20: upload reference content — not just text instructions](#tip-20-upload-reference-content--not-just-text-instructions)
- [Tip 21: use Claude for email and DM drafts](#tip-21-use-claude-for-email-and-dm-drafts)
- [Tip 22: use Claude to build brand voice docs](#tip-22-use-claude-to-build-brand-voice-docs)
- [Tip 23: markdown is underrated for creatives](#tip-23-markdown-is-underrated-for-creatives)
- [Tip 24: use Claude to prep for hard conversations](#tip-24-use-claude-to-prep-for-hard-conversations)
- [Tip 25: ask Claude to double-check its own output](#tip-25-ask-claude-to-double-check-its-own-output)

**Cursor Tips**
- [Tip 26: Cursor is not just for engineers](#tip-26-cursor-is-not-just-for-engineers)
- [Tip 27: use Cursor chat before touching anything](#tip-27-use-cursor-chat-before-touching-anything)
- [Tip 28: use @ to point Cursor at the right file](#tip-28-use--to-point-cursor-at-the-right-file)
- [Tip 29: ask Cursor to explain before it changes](#tip-29-ask-cursor-to-explain-before-it-changes)
- [Tip 30: Cursor for landing page edits](#tip-30-cursor-for-landing-page-edits)
- [Tip 31: Cursor + Lovable ❤️ = ship without engineers](#tip-31-cursor--lovable-️--ship-without-engineers)
- [Tip 32: Cursor for fixing broken things without calling dev](#tip-32-cursor-for-fixing-broken-things-without-calling-dev)
- [Tip 33: use Cursor to edit copy directly in the codebase](#tip-33-use-cursor-to-edit-copy-directly-in-the-codebase)
- [Tip 34: Cursor for CMS and config edits](#tip-34-cursor-for-cms-and-config-edits)
- [Tip 35: Cursor for simple automations and scripts](#tip-35-cursor-for-simple-automations-and-scripts)

**Creative Workflow Tips**
- [Tip 36: give AI your references, not just your instructions](#tip-36-give-ai-your-references-not-just-your-instructions)
- [Tip 37: the "yes and" prompt method](#tip-37-the-yes-and-prompt-method)
- [Tip 38: treat AI like a collaborator, not a search engine](#tip-38-treat-ai-like-a-collaborator-not-a-search-engine)
- [Tip 39: AI has no taste — you do](#tip-39-ai-has-no-taste--you-do)
- [Tip 40: build your AI workflow like a creative process](#tip-40-build-your-ai-workflow-like-a-creative-process)
- [Tip 41: keep a swipe file for prompts that work](#tip-41-keep-a-swipe-file-for-prompts-that-work)
- [Tip 42: use AI to speed up research, not replace thinking](#tip-42-use-ai-to-speed-up-research-not-replace-thinking)
- [Tip 43: the one-person creative studio is here](#tip-43-the-one-person-creative-studio-is-here)
- [Tip 44: invest in your own workflow](#tip-44-invest-in-your-own-workflow)
- [Tip 45: share what you learn](#tip-45-share-what-you-learn)
...
1. first ask it to define your audience with you
2. then ask it to write the positioning statement
3. then the tone of voice section
4. then the messaging pillars
...
workflow:
1. build the initial product in Lovable ❤️ (describe what you want, iterate with prompts)
2. export the code or connect the GitHub repo
